export const translations = {
  pt: {
    ...
    about: {
      role: 'Desenvolvedor Full Stack',
      bioStart: 'Sou desenvolvedor full stack especializado no ',
      bioStack: 'ecossistema Microsoft',
      bioEnd: '. Construo APIs e microsserviços em C# e ASP.NET Core, entrego front-end web com Blazor (WebAssembly e Server) e apps mobile cross-platform com .NET MAUI. Modelo dados com SQL Server e Entity Framework, e faço deploy de tudo no Azure (App Service, Static Web Apps e Azure SQL). Foco em entregar software performático, escalável e bem arquitetado.',
    },
    experience: {
      titlePrefix: 'Minha ',
    ...
    contact: {
      ...
      toastSuccessDescription: 'Recebi sua mensagem e respondo em breve. Obrigado pelo contato!',
      toastErrorTitle: 'Erro ao enviar',
      toastErrorDescription: 'Algo deu errado. Tenta novamente em instantes ou me chama no LinkedIn.',
  ...
  en: {
    ...
    about: {
      role: 'Full Stack Developer',
      bioStart: 'Full stack developer specialized in the ',
      bioStack: 'Microsoft ecosystem',
      bioEnd: '. I build APIs and microservices in C# and ASP.NET Core, deliver web front-ends with Blazor (WebAssembly and Server) and cross-platform mobile apps with .NET MAUI. I model data with SQL Server and Entity Framework, and deploy everything on Azure (App Service, Static Web Apps and Azure SQL). Focused on shipping performant, scalable, well-architected software.',
    },
    experience: {
      titlePrefix: 'My ',
    ...
    contact: {
      ...
      toastSuccessDescription: "I got your message and I'll get back to you soon. Thanks for reaching out!",
      toastErrorTitle: 'Failed to send',
      toastErrorDescription: 'Something went wrong. Please try again in a moment, or reach out via LinkedIn.',
