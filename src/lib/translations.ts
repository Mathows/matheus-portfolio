export const translations = {
  pt: {
    ...
    about: {
      role: 'Desenvolvedor Full Stack',
      bioStart: 'Sou desenvolvedor full stack há 2 anos. Trabalho com ',
      bioStack: 'C#, .NET, SQL Server, React, Blazor e DevExpress',
      bioEnd: ', criando aplicações modernas e performáticas.',
    },
    experience: {
      titlePrefix: 'Minha ',
  ...
  en: {
    ...
    about: {
      role: 'Full Stack Developer',
      bioStart: "I've been a full stack developer for 2 years. I work with ",
      bioStack: 'C#, .NET, SQL Server, React, Blazor and DevExpress',
      bioEnd: ', building modern and performant applications.',
    },
    experience: {
      titlePrefix: 'My ',
